        ...
        <div className='flex flex-col justify-around'>
          <div className='sm:px-16 px-2'>
            ...
            <p className='mt-3 mb-6 text-[17px] max-w-3xl leading-[30px]'>
              👨‍💻 Hi, I'm Hazi Aafrid Baba, a data science enthusiast with a solid background in pharmacy and a passion for uncovering data-driven insights. Currently pursuing my Post Graduate Program in Data Science Engineering. As a <a className='text-green-300 hover:text-green-500 duration-300' href='https://www.linkedin.com/in/contacthazi/' target='_blank'>data science professional</a>, I specialize in Python, machine learning, and advanced statistical analysis to solve complex problems.
              <br />
            ...
            <ButtonLink
              url='https://drive.google.com/file/d/1n9JB3cYkpeT9VTuHY9sPN2gvgqkgitiq/view?usp=drive_link'
              text='View Resume →'
              padding={`p-3`}
            />
          </div>
